...
.field private I:Landroid/support/v7/widget/ga;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, La/b/e/a/a;->toolbarStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p1, p0}, Landroid/support/v7/widget/ba;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-direct {p1, p0}, Landroid/support/v7/widget/ca;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    sget-object v0, La/b/e/a/j;->Toolbar:[I
    ...
    sget p2, La/b/e/a/j;->Toolbar_titleTextAppearance:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/aa;->g(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->l:I

    sget p2, La/b/e/a/j;->Toolbar_subtitleTextAppearance:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_android_gravity:I

    iget p3, p0, Landroid/support/v7/widget/Toolbar;->w:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/aa;->e(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->w:I

    sget p2, La/b/e/a/j;->Toolbar_buttonGravity:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_titleMargin:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/aa;->b(II)I

    move-result p2

    sget p3, La/b/e/a/j;->Toolbar_titleMargins:I

    invoke-virtual {p1, p3}, Landroid/support/v7/widget/aa;->f(I)Z
    ...
    invoke-virtual {p1, p3, p2}, Landroid/support/v7/widget/aa;->b(II)I
    ...
    sget p2, La/b/e/a/j;->Toolbar_titleMarginStart:I

    const/4 p3, -0x1

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/aa;->b(II)I
    ...
    :cond_1
    sget p2, La/b/e/a/j;->Toolbar_titleMarginEnd:I
    ...
    :cond_2
    sget p2, La/b/e/a/j;->Toolbar_titleMarginTop:I
    ...
    :cond_3
    sget p2, La/b/e/a/j;->Toolbar_titleMarginBottom:I
    ...
    :cond_4
    sget p2, La/b/e/a/j;->Toolbar_maxButtonHeight:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/aa;->c(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/Toolbar;->o:I

    sget p2, La/b/e/a/j;->Toolbar_contentInsetStart:I
    ...
    sget v2, La/b/e/a/j;->Toolbar_contentInsetEnd:I

    invoke-virtual {p1, v2, v0}, Landroid/support/v7/widget/aa;->b(II)I

    move-result v2

    sget v3, La/b/e/a/j;->Toolbar_contentInsetLeft:I

    invoke-virtual {p1, v3, v1}, Landroid/support/v7/widget/aa;->c(II)I

    move-result v3

    sget v4, La/b/e/a/j;->Toolbar_contentInsetRight:I

    invoke-virtual {p1, v4, v1}, Landroid/support/v7/widget/aa;->c(II)I

    move-result v4

    invoke-direct {p0}, Landroid/support/v7/widget/Toolbar;->g()V

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/O;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/O;->a(II)V
    ...
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/O;

    invoke-virtual {v3, p2, v2}, Landroid/support/v7/widget/O;->b(II)V

    :cond_6
    sget p2, La/b/e/a/j;->Toolbar_contentInsetStartWithNavigation:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_contentInsetEndWithActions:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_collapseIcon:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_collapseContentDescription:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_title:I
    ...
    :cond_7
    sget p2, La/b/e/a/j;->Toolbar_subtitle:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_popupTheme:I
    ...
    sget p2, La/b/e/a/j;->Toolbar_navigationIcon:I
    ...
    :cond_9
    sget p2, La/b/e/a/j;->Toolbar_navigationContentDescription:I
    ...
    :cond_a
    sget p2, La/b/e/a/j;->Toolbar_logo:I
    ...
    :cond_b
    sget p2, La/b/e/a/j;->Toolbar_logoDescription:I
    ...
    :cond_c
    sget p2, La/b/e/a/j;->Toolbar_titleTextColor:I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/aa;->a(II)I
    ...
    :cond_d
    sget p2, La/b/e/a/j;->Toolbar_subtitleTextColor:I
...
.method private a(I)I
    ...
    invoke-static {p0}, La/b/d/g/t;->c(Landroid/view/View;)I
...
.method private a(Landroid/view/View;)I
    ...
    invoke-static {p1}, La/b/d/g/j;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v0

    invoke-static {p1}, La/b/d/g/j;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p2, v4}, La/b/d/g/h;->a(II)I
...
.method private g()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/O;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Landroid/support/v7/widget/O;
...
.method private getMenuInflater()Landroid/view/MenuInflater;
    ...
    new-instance v0, La/b/e/d/d;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, La/b/e/d/d;-><init>(Landroid/content/Context;)V
...
.method private k()V
    ...
    sget v3, La/b/e/a/a;->toolbarNavigationButtonStyle:I
...
.method c()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/da;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public getWrapper()Landroid/support/v7/widget/B;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ga;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ga;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ga;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, La/b/d/g/t;->d(Landroid/view/View;)I
