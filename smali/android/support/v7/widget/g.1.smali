...
# instance fields
.field A:Landroid/support/v7/widget/g$c;

.field private B:Landroid/support/v7/widget/g$b;

.field final C:Landroid/support/v7/widget/g$f;

.field D:I

.field j:Landroid/support/v7/widget/g$d;
...
.field y:Landroid/support/v7/widget/g$e;

.field z:Landroid/support/v7/widget/g$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v0, La/b/e/a/g;->abc_action_menu_layout:I

    sget v1, La/b/e/a/g;->abc_action_menu_item_layout:I
    ...
    iput-object p1, p0, Landroid/support/v7/widget/g;->w:Landroid/util/SparseBooleanArray;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/g;->C:Landroid/support/v7/widget/g$f;

    return-void
.end method

.method static synthetic a(Landroid/support/v7/widget/g;)Landroid/support/v7/view/menu/k;
    .locals 0
...
.method static synthetic b(Landroid/support/v7/widget/g;)Landroid/support/v7/view/menu/k;
    .locals 0
...
.method static synthetic c(Landroid/support/v7/widget/g;)Landroid/support/v7/view/menu/u;
    .locals 0
...
.method static synthetic d(Landroid/support/v7/widget/g;)Landroid/support/v7/view/menu/k;
    .locals 0
...
.method static synthetic e(Landroid/support/v7/widget/g;)Landroid/support/v7/view/menu/k;
    .locals 0
...
.method static synthetic f(Landroid/support/v7/widget/g;)Landroid/support/v7/view/menu/u;
    .locals 0
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/k;)V
    ...
    invoke-static {p1}, La/b/e/d/a;->a(Landroid/content/Context;)La/b/e/d/a;
    ...
    invoke-virtual {p1}, La/b/e/d/a;->f()Z
    ...
    invoke-virtual {p1}, La/b/e/d/a;->a()I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/g;->o:I
    ...
    invoke-virtual {p1}, La/b/e/d/a;->b()I
    ...
    :cond_2
    iget p1, p0, Landroid/support/v7/widget/g;->o:I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;

    iget-boolean v0, p0, Landroid/support/v7/widget/g;->l:Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/g;->k:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/o;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v1, p0, Landroid/support/v7/widget/g;->k:Landroid/graphics/drawable/Drawable;

    iput-boolean v2, p0, Landroid/support/v7/widget/g;->l:Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;
    ...
    :cond_5
    iput-object v1, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;

    :goto_0
    iput p1, p0, Landroid/support/v7/widget/g;->p:I
    ...
    iput p1, p0, Landroid/support/v7/widget/g;->v:I

    iput-object v1, p0, Landroid/support/v7/widget/g;->x:Landroid/view/View;
...
.method public a(Landroid/content/res/Configuration;)V
    ...
    iget-boolean p1, p0, Landroid/support/v7/widget/g;->r:Z
...
.method public a(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/g;->l:Z
...
.method public a(Landroid/support/v7/view/menu/n;Landroid/support/v7/view/menu/u$a;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/g;->B:Landroid/support/v7/widget/g$b;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/g;->B:Landroid/support/v7/widget/g$b;
...
.method public a(Z)V
    ...
    invoke-virtual {v3}, Landroid/support/v7/view/menu/n;->a()La/b/d/g/g;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, La/b/d/g/g;->a(La/b/d/g/g$a;)V
    ...
    :goto_1
    iget-boolean v1, p0, Landroid/support/v7/widget/g;->m:Z
    ...
    iget-object p1, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;
...
.method public a()Z
    ...
    iget v5, v0, Landroid/support/v7/widget/g;->p:I
    ...
    :goto_2
    iget-boolean v12, v0, Landroid/support/v7/widget/g;->u:Z
    ...
    :cond_4
    iget-boolean v4, v0, Landroid/support/v7/widget/g;->m:Z
    ...
    iget-object v4, v0, Landroid/support/v7/widget/g;->w:Landroid/util/SparseBooleanArray;

    invoke-virtual {v4}, Landroid/util/SparseBooleanArray;->clear()V

    iget-boolean v8, v0, Landroid/support/v7/widget/g;->s:Z

    if-eqz v8, :cond_7

    iget v8, v0, Landroid/support/v7/widget/g;->v:I
    ...
    iget-object v15, v0, Landroid/support/v7/widget/g;->x:Landroid/view/View;

    invoke-virtual {v0, v14, v15, v7}, Landroid/support/v7/widget/g;->a(Landroid/support/v7/view/menu/n;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v15

    iget-object v12, v0, Landroid/support/v7/widget/g;->x:Landroid/view/View;

    if-nez v12, :cond_8

    iput-object v15, v0, Landroid/support/v7/widget/g;->x:Landroid/view/View;

    :cond_8
    iget-boolean v12, v0, Landroid/support/v7/widget/g;->s:Z
    ...
    iget-boolean v2, v0, Landroid/support/v7/widget/g;->s:Z
    ...
    iget-object v2, v0, Landroid/support/v7/widget/g;->x:Landroid/view/View;

    invoke-virtual {v0, v14, v2, v7}, Landroid/support/v7/widget/g;->a(Landroid/support/v7/view/menu/n;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v2

    move/from16 v17, v3

    iget-object v3, v0, Landroid/support/v7/widget/g;->x:Landroid/view/View;

    if-nez v3, :cond_10

    iput-object v2, v0, Landroid/support/v7/widget/g;->x:Landroid/view/View;

    :cond_10
    iget-boolean v3, v0, Landroid/support/v7/widget/g;->s:Z
...
.method public a(Landroid/support/v7/view/menu/B;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Landroid/support/v7/view/menu/B;->p()Landroid/view/Menu;
    ...
    iput v2, p0, Landroid/support/v7/widget/g;->D:I
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroid/support/v7/widget/g$a;-><init>(Landroid/support/v7/widget/g;Landroid/content/Context;Landroid/support/v7/view/menu/B;Landroid/view/View;)V

    iput-object v2, p0, Landroid/support/v7/widget/g;->z:Landroid/support/v7/widget/g$a;

    iget-object v0, p0, Landroid/support/v7/widget/g;->z:Landroid/support/v7/widget/g$a;
...
.method public a(Landroid/view/ViewGroup;I)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;
...
.method public b(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/g;->u:Z
...
.method public c(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/g;->m:Z
...
.method public e()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/g;->A:Landroid/support/v7/widget/g$c;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/g;->A:Landroid/support/v7/widget/g$c;

    return v1

    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/g;->y:Landroid/support/v7/widget/g$e;
...
.method public h()Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/g;->g()Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/g;->A:Landroid/support/v7/widget/g$c;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/g;->j:Landroid/support/v7/widget/g$d;
    ...
    invoke-direct/range {v1 .. v6}, Landroid/support/v7/widget/g$e;-><init>(Landroid/support/v7/widget/g;Landroid/content/Context;Landroid/support/v7/view/menu/k;Landroid/view/View;Z)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/g;->A:Landroid/support/v7/widget/g$c;
